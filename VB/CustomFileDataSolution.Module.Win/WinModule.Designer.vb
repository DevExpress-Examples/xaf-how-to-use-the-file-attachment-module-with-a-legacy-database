...
Imports System
Namespace CustomFileDataSolution.Module.Win
	Partial Public Class CustomFileDataSolutionWindowsFormsModule
		''' <summary> 
		...
		Private Sub InitializeComponent()
			' 
			' CustomFileDataSolutionWindowsFormsModule
			' 
			Me.RequiredModuleTypes.Add(GetType(CustomFileDataSolution.Module.CustomFileDataSolutionModule))
